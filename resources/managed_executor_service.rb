...
# <> @attribute maximumpoolsize Specifies the maximum number of threads that a thread pool can contain.
attribute :maximumpoolsize, kind_of: Integer, default: 2147483647
...
# <> @attribute taskqueuecapacity Specifies the number of submitted tasks that can be stored in the task queue awaiting execution.
attribute :taskqueuecapacity, kind_of: Integer, default: 2147483647
